<x-layouts.app>
    ...
    <div class="mt-6 flex gap-4">
        ...
        <a href="{{ route('penjualan.surat-jalan', $penjualan) }}" target="_blank" class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition inline-flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
