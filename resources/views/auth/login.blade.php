...
>
    <!-- ICON EYE -->
    <svg id="icon-eye" class="w-5 h-5 block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <svg id="icon-eye-off" class="w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7
                 a9.97 9.97 0 012.344-3.817M6.223 6.223A9.97 9.97 0 0112 5
                 c4.478 0 8.268 2.943 9.543 7
                 a10.05 10.05 0 01-4.132 5.411M15 12a3 3 0 00-4.243-2.828
                 M3 3l18 18"/>
    </svg>
</button>
