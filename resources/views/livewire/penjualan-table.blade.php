<div class="space-y-6">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            {{-- Gudang --}}
            <div class="space-y-2" x-data="{ open: false, value: @entangle('gudang_id').live }" @click.away="open = false">
            ...
            {{-- Status --}}
            <div class="space-y-2" x-data="{ open: false, value: @entangle('status').live, labels: { '': 'Semua Status', 'selesai': 'Selesai', 'belum_lunas': 'Belum Lunas' } }" @click.away="open = false">
