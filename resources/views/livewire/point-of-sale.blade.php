<div class="flex gap-6 h-[calc(100vh-180px)] overflow-hidden">
    ...
    <div class="w-1/3 flex flex-col h-full overflow-hidden">
        <div class="card h-full min-h-0 flex flex-col shadow-lg bg-white rounded-2xl p-6 overflow-hidden">
            <h3 class="text-xl font-bold text-gray-900 mb-4 tracking-wide flex-shrink-0">Keranjang</h3>
            ...
            <div class="flex-1 min-h-0 overflow-y-auto space-y-4 pr-2">
                ...
                <div>
                    ...
                    <input type="number" wire:model.live="diskon" class="input-field" min="0" placeholder="0">
                </div>

                <!-- Summary -->
                <div class="border-t border-b border-gray-200 py-3 space-y-2">
                    ...
                    <div class="flex justify-between text-sm text-red-500">
                        <span>Diskon</span>
                        <span class="font-medium">- Rp {{ number_format($this->diskon, 0, ',', '.') }}</span>
                    </div>
                    @endif
