<div class="flex justify-center items-center py-8 bg-gray-50">
    <form wire:submit="save" class="card max-w-xl w-full shadow-lg p-8">
        <div class="space-y-6">
            <div>
                <label for="nama_gudang" class="block text-sm font-medium text-gray-700 mb-1">Nama Gudang
                    *</label>
                <input type="text" id="nama_gudang" wire:model="nama_gudang" class="input-field"
            ...
            <div>
                ...
                <textarea id="lokasi" wire:model="lokasi" class="input-field" rows="3"
                    placeholder="Lokasi gudang"></textarea>
